        ...
        <div class="row w-100 mx-0">
          <div class="col-lg-4 mx-auto">
            <div class="auth-form-light text-left py-5 px-4 px-sm-5">
              ...
              <form class="pt-3" action="/sesi/create" method="POST">
                @csrf
                <div class="form-group">
                  <input type="text" class="form-control form-control-lg" id="exampleInputUsername1" value="{{Session::get('name')}}" name="name" placeholder="Username">
                </div>
                <div class="form-group">
                ...
                <div class="text-center mt-4 font-weight-light">
                  Already have an account? <a href="/sesi" class="text-primary">Login</a>
                </div>
              </form>
            </div>
          </div>
