  ...
  <div class="container-scroller">
        ...
        <ul class="navbar-nav navbar-nav-right">
          ...
          <li class="nav-item nav-profile dropdown">
            <a class="nav-link dropdown-toggle" href="#" data-toggle="dropdown" id="profileDropdown">
              <img src="{{ asset('Assets/images/faces/face18.jpg') }}" alt="profile"/>
            </a>
    ...
    <div class="container-fluid page-body-wrapper">
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="ui-basic">
              <ul class="nav flex-column sub-menu">
                ...
                <li class="nav-item"> <a class="nav-link" href="{{ route('reservasi.index')}}">Data Reservasi</a></li>
              </ul>
            </div>
          </li>
          <li class="nav-item">
      ...
      <div class="main-panel">
        ...
        <footer class="footer">
          <div class="d-sm-flex col-lg justify-content-center justify-content-sm-between">
